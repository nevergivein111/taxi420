...
echo"No Search result is found ...";
echo "<br></br>";

}
if(isset($this->params['named']['q']) && strlen($this->params['named']['q']) <= 4 && empty($singles))
	

	{


echo "For getting most desirable result Kindly  <br></br> User More than four character in word ";
