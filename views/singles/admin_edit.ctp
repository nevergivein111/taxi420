...
<?php echo $this->Form->create('Single');?>
	<fieldset>
 		<legend><?php __('Admin Edit Single'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Single.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Single.id'))); ?></li>
