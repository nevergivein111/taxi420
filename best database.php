...
--
-- Host: localhost
-- Generation Time: Jun 09, 2011 at 07:47 PM
...
(33, 'Willemstad', 'ANT', 'CuraÃƒÂ§ao', 2345),
...
(45, 'BejaÃƒÂ¯a', 'DZA', 'BejaÃƒÂ¯a', 117162),
...
(52, 'GhardaÃƒÂ¯a', 'DZA', 'GhardaÃƒÂ¯a', 89415),
...
(61, 'South Hill', 'AIA', 'Ã¢â‚¬â€œ', 961),
(62, 'The Valley', 'AIA', 'Ã¢â‚¬â€œ', 595),
...
(79, 'LanÃƒÂºs', 'ARG', 'Buenos Aires', 469735),
...
(129, 'Oranjestad', 'ABW', 'Ã¢â‚¬â€œ', 29034),
...
(147, 'MingaÃƒÂ§evir', 'AZE', 'MingaÃƒÂ§evir', 93900),
...
(220, 'Sao GonÃƒÂ§alo', 'BRA', 'Rio de Janeiro', 869254),
(221, 'Nova IguaÃƒÂ§u', 'BRA', 'Rio de Janeiro', 862225),
...
(280, 'Foz do IguaÃƒÂ§u', 'BRA', 'Parana', 259425),
...
(343, 'MaracanaÃƒÂº', 'BRA', 'Ceara', 162022),
...
(351, 'CamaÃƒÂ§ari', 'BRA', 'Bahia', 149146),
...
(365, 'PoÃƒÂ§os de Caldas', 'BRA', 'Minas Gerais', 129683),
...
(378, 'Moji-GuaÃƒÂ§u', 'BRA', 'Sao Paulo', 123782),
...
(388, 'BraganÃƒÂ§a Paulista', 'BRA', 'Sao Paulo', 116929),
...
(396, 'JaÃƒÂº', 'BRA', 'Sao Paulo', 109965),
...
(444, 'Sao LourenÃƒÂ§o da Mata', 'BRA', 'Pernambuco', 91999),
...
(451, 'PalhoÃƒÂ§a', 'BRA', 'Santa Catarina', 89465),
(452, 'Barra do Pirai', 'BRA', 'Rio de Janeiro', 89388),
(453, 'Bento GonÃƒÂ§alves', 'BRA', 'Rio Grande do Sul', 89254),
...
(556, 'ViÃƒÂ±a del Mar', 'CHL', 'Valparaiso', 312493),
...
(563, 'Rancagua', 'CHL', 'OÃ‚Â´Higgins', 212977),
...
(668, 'LÃ‚Â´Hospitalet de Llobregat', 'ESP', 'Katalonia', 247986),
(669, 'Granada', 'ESP', 'Andalusia', 244767),
(670, 'A CoruÃƒÂ±a (La CoruÃƒÂ±a)', 'ESP', 'Galicia', 243402),
...
(680, 'Pamplona [IruÃƒÂ±a]', 'ESP', 'Navarra', 180483),
...
(699, 'LogroÃƒÂ±o', 'ESP', 'La Rioja', 127093),
...
(773, 'Las PiÃƒÂ±as', 'PHL', 'National Capital Reg', 472780),
...
(777, 'ParaÃƒÂ±aque', 'PHL', 'National Capital Reg', 449811),
...
(782, 'DasmariÃƒÂ±as', 'PHL', 'Southern Tagalog', 379520),
...
(806, 'BiÃƒÂ±an', 'PHL', 'Southern Tagalog', 201186),
...
(915, 'Gibraltar', 'GIB', 'Ã¢â‚¬â€œ', 27025),
...
(920, 'Tamuning', 'GUM', 'Ã¢â‚¬â€œ', 9500),
(921, 'AgaÃƒÂ±a', 'GUM', 'Ã¢â‚¬â€œ', 1139),
...
(932, 'Le-Cap-HaÃƒÂ¯tien', 'HTI', 'Nord', 102233),
...
(1449, 'Reykjavik', 'ISL', 'HofuÃƒÂ°borgarsvÃƒÂ¦ÃƒÂ°i', 109184),
...
(1489, 'Reggio nellÃ‚Â´ Emilia', 'ITA', 'Emilia-Romagna', 143664),
...
(1502, 'ForlÃƒÂ¬', 'ITA', 'Emilia-Romagna', 107475),
...
(1791, 'Flying Fish Cove', 'CXR', 'Ã¢â‚¬â€œ', 700),
...
(1806, 'Maroua', 'CMR', 'ExtrÃƒÂªme-Nord', 143000),
...
(1901, 'XiÃ‚Â´an', 'CHN', 'Shaanxi', 2761400),
...
(1991, 'TaiÃ‚Â´an', 'CHN', 'Shandong', 350696),
...
(2065, 'BeiÃ‚Â´an', 'CHN', 'Heilongjiang', 204899),
...
(2128, 'RuiÃ‚Â´an', 'CHN', 'Zhejiang', 156468),
...
(2137, 'JiÃ‚Â´an', 'CHN', 'Jiangxi', 148583),
...
(2171, 'HuaiÃ‚Â´an', 'CHN', 'Jiangsu', 131149),
...
(2262, 'CÃƒÂºcuta', 'COL', 'Norte de Santander', 606932),
...
(2269, 'Pasto', 'COL', 'NariÃƒÂ±o', 332396),
...
(2302, 'Kisangani', 'COD', 'Haute-ZaÃƒÂ¯re', 417517),
...
(2452, 'Luxembourg [Luxemburg/LÃƒÂ«tzebuerg]', 'LUX', 'Luxembourg', 80700),
(2453, 'El-AaiÃƒÂºn', 'ESH', 'El-AaiÃƒÂºn', 169000),
...
(2635, 'TÃƒÂºxpam', 'MEX', 'Veracruz', 126475),
...
(2641, 'Tlajomulco de ZÃƒÂºÃƒÂ±iga', 'MEX', 'Jalisco', 123220),
...
(2656, 'AcuÃƒÂ±a', 'MEX', 'Coahuila de Zaragoza', 110388),
...
(2693, 'Bender (TÃƒÂ®ghina)', 'MDA', 'Bender (TÃƒÂ®ghina)', 125700),
(2694, 'Monte-Carlo', 'MCO', 'Ã¢â‚¬â€œ', 13154),
(2695, 'Monaco-Ville', 'MCO', 'Ã¢â‚¬â€œ', 1234),
...
(2703, 'NaÃƒÂ§ala-Porto', 'MOZ', 'Nampula', 158248),
...
(2727, 'Yangor', 'NRU', 'Ã¢â‚¬â€œ', 4050),
(2728, 'Yaren', 'NRU', 'Ã¢â‚¬â€œ', 559),
...
(2805, 'Alofi', 'NIU', 'Ã¢â‚¬â€œ', 682),
(2806, 'Kingston', 'NFK', 'Ã¢â‚¬â€œ', 800),
(2807, 'Oslo', 'NOR', 'Oslo', 508726),
(2808, 'Bergen', 'NOR', 'Hordaland', 230948),
(2809, 'Trondheim', 'NOR', 'SÃƒÂ¸r-TrÃƒÂ¸ndelag', 150166),
(2810, 'Stavanger', 'NOR', 'Rogaland', 108848),
(2811, 'BÃƒÂ¦rum', 'NOR', 'Akershus', 101340),
...
(2974, 'Paris', 'FRA', 'ÃƒÅ½le-de-France', 2125246),
...
(3208, 'Singapore', 'SGP', 'Ã¢â‚¬â€œ', 4017733),
(3209, 'Bratislava', 'SVK', 'Bratislava', 448292),
(3210, 'Kosice', 'SVK', 'VÃƒÂ½chodne Slovensko', 241874),
(3211, 'Presov', 'SVK', 'VÃƒÂ½chodne Slovensko', 93977),
...
(3315, 'KÃƒÂ¸benhavn', 'DNK', 'KÃƒÂ¸benhavn', 495699),
...
(3337, 'NÃ‚Â´Djamena', 'TCD', 'Chari-Baguirmi', 530965),
...
(3346, 'Hradec Kralove', 'CZE', 'VÃƒÂ½chodni Cechy', 98080),
(3347, 'ÃƒÅ¡sti nad Labem', 'CZE', 'Severni Cechy', 95491),
(3348, 'Pardubice', 'CZE', 'VÃƒÂ½chodni Cechy', 91309),
...
(3364, 'Mersin (IÃƒÂ§el)', 'TUR', 'IÃƒÂ§el', 587212),
...
(3388, 'Ãƒâ€¡orum', 'TUR', 'Ãƒâ€¡orum', 145495),
...
(3398, 'Ãƒâ€¡orlu', 'TUR', 'Tekirdag', 123300),
...
(3484, 'Debrecen', 'HUN', 'HajdÃƒÂº-Bihar', 203648),
(3485, 'Miskolc', 'HUN', 'Borsod-AbaÃƒÂºj-Zemple', 172357),
...
(3538, 'CittÃƒÂ  del Vaticano', 'VAT', 'Ã¢â‚¬â€œ', 455),
...
(3567, 'CarÃƒÂºpano', 'VEN', 'Sucre', 119639),
...
(3773, 'BiÃƒÂªn Hoa', 'VNM', 'Dong Nai', 282095),
...
(3785, 'Phan ThiÃƒÂªt', 'VNM', 'Binh Thuan', 114236),
...
('CAF', 'Central African Republic', 'Africa', 'Central Africa', 622984.00, 1960, 3615000, 44.0, 1054.00, 993.00, 'Centrafrique/BÃƒÂª-AfrÃƒÂ®ka', 'Republic', 'Ange-Felix Patasse', 1889, 'CF'),
...
('CZE', 'Czech Republic', 'Europe', 'Eastern Europe', 78866.00, 1993, 10278100, 74.5, 55017.00, 52037.00, 'Ã‚Â¸esko', 'Republic', 'Vaclav Havel', 3339, 'CZ'),
...
('DOM', 'Dominican Republic', 'North America', 'Caribbean', 48511.00, 1844, 8495000, 73.2, 15846.00, 15076.00, 'RepÃƒÂºblica Dominicana', 'Republic', 'Hipolito Mejia Dominguez', 587, 'DO'),
('DZA', 'Algeria', 'Africa', 'Northern Africa', 2381741.00, 1962, 31471000, 69.7, 49982.00, 46966.00, 'Al-JazaÃ¢â‚¬â"¢ir/Algerie', 'Republic', 'Abdelaziz Bouteflika', 35, 'DZ'),
...
('MOZ', 'Mozambique', 'Africa', 'Eastern Africa', 801590.00, 1975, 19680000, 37.5, 2891.00, 2711.00, 'MoÃƒÂ§ambique', 'Republic', 'Joaquim A. Chissano', 2698, 'MZ'),
...
('OMN', 'Oman', 'Asia', 'Middle East', 309500.00, 1951, 2542000, 71.8, 16904.00, 16153.00, 'Ã‚Â´Uman', 'Monarchy (Sultanate)', 'Qabus ibn Said', 2821, 'OM'),
...
('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 4000.00, NULL, 235000, 74.8, 818.00, 781.00, 'Polynesie franÃƒÂ§aise', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3016, 'PF'),
...
('SAU', 'Saudi Arabia', 'Asia', 'Middle East', 2149690.00, 1932, 21607000, 67.8, 137635.00, 146171.00, 'Al-Ã‚Â´Arabiya as-Saudiya', 'Monarchy', 'Fahd ibn Abdul-Aziz al-Saud', 3173, 'SA'),
...
('URY', 'Uruguay', 'South America', 'South America', 175016.00, 1828, 3337000, 75.2, 20831.00, 19967.00, 'Uruguay', 'Republic', 'Jorge Batlle IbaÃƒÂ±ez', 3492, 'UY'),
...
('VNM', 'Vietnam', 'Asia', 'Southeast Asia', 331689.00, 1945, 79832000, 69.3, 21929.00, 22834.00, 'ViÃƒÂªt Nam', 'Socialistic Republic', 'Tran Duc Luong', 3770, 'VN'),
